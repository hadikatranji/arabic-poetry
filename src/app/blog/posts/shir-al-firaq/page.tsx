...
const ABUFIRAS_VERSE = {
  verse:
    "أَلا لا أرى الأحداثَ حَمداً ولا ذَمّا\nفيا حَسرَتا مِمَّا مَضى وأُسىً مِمّا",
  poet: "أبو فراس الحمداني",
  meaning:
    "أبو فراس في أسره يُعبّر عن ألم مزدوج: حسرة على الماضي الجميل الذي رحل، وأسى من الحاضر المرير. الفراق في روميّاته ليس فراق حبيبة فحسب — بل فراق الحرية والوطن والكرامة.",
};

const IBN_ZAYDOUN_VERSE = {
  verse:
    "يا ليلةً لو دامَت لَو جُدتِ\nبِزيارةٍ لكانَت النُّعمى",
  poet: "ابن زيدون",
  meaning:
    "من رسالة ابن زيدون الشعرية إلى ولادة بنت المستكفي بعد الفراق. يتمنى أن تطول اللحظة — لحظة اللقاء — لكن الليل لا يطيع المُحبّين. الفراق عند ابن زيدون ظلّ مؤلماً حتى آخر حياته.",
};
