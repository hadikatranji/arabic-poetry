...
const IBN_ZAYDUN_VERSE = {
  ...
  poet: "ابن زيدون",
  meaning:
    "مطلع نونيّة ابن زيدون الشهيرة، كتبها من المدينة المنورة للزهراء (قرطبة) إلى حبيبته ولادة بنت المستكفي. الأُفق الطلق والأرض الجميلة يتناقضان مع ألم الغياب — الطبيعة جميلة لكن المشاعر موجعة. من أرقّ مطالع الغزل الأندلسي.",
};
    ...
    <BlogPostLayout post={post} tableOfContents={TOC}>
      ...
      <section id="ghazal">
        ...
        <p className="text-[var(--muted)] mb-5">
          ...
          المستكفي حبّاً جمع بين الشعر والسياسة والمأساة. حين فُرّق بينهما
          كتب نونيّته الخالدة من المدينة المنورة:
        </p>
