...
const THEMES = [
  {
    ...
    desc: "شعر الحب والوجد والشوق — من معلقة امرئ القيس وعنترة إلى مجنون ليلى وأبي فراس",
    examples: ["امرؤ القيس", "عنترة بن شداد", "مجنون ليلى", "أبو فراس الحمداني"],
    color: "var(--accent)",
    dedicated: true,
  },
  {
  ...
  {
    name: "شعر عن الأم",
    nameEn: "Poetry about Mothers",
    icon: "🤍",
    href: "/explore/themes/om",
    desc: "أجمل ما قاله الشعراء في الأمهات — من حافظ إبراهيم إلى محمود درويش",
    examples: ["حافظ إبراهيم", "محمود درويش"],
    color: "var(--accent)",
    dedicated: true,
  },
  {
