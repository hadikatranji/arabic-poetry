...
const THEMES = [
  ...
  },
  {
    ...
    icon: "🌙",
    href: "/explore/themes/wataniyat",
    desc: "شعر الوطن والهوية والانتماء — من الشابي وأحمد شوقي إلى محمود درويش وفدوى طوقان وسميح القاسم",
    examples: ["أبو القاسم الشابي", "أحمد شوقي", "محمود درويش", "سميح القاسم"],
    color: "var(--accent)",
    dedicated: true,
  },
  {
